    ...
    query = """
        ...
        ,  case when Designed IS NOT NULL
                then case when cslq.Quoted is NOT NULL
                        then case when Designed >= cslq.Quoted
                            ...
                            else 'No Quoted data' -- quoted data missing
                            end
        ...
        from ( --info
            ...
            left join (
                ...
                where TaskID in (15,40) --- taskid = 40 is for capacity study tasks, and 15 = old capacity study R@R tasks
            ) pst
            ...
            ) as cap on ps.PartSupplierID=cap.PartSupplierID
